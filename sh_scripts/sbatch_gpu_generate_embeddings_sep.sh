# Run as ./sbatch_gpu_generate_embeddings_sep.sh <job_name> <task> <model_name>
...
srun python3 ./mint/embeddings_baselines.py --task "${TASK}" --model_name "${MODEL}" --devices "0" --sep_embed
